...
<div class="nav-tabs-custom">
    ...
    <div class="tab-content">
        <div class="tab-pane active" id="tab_1" style="max-width:800px;">
                <form role="form" action="<?php echo U('Sys/addNotice');?>" id="form-add">
                    ...
                    <div class="form-group" >
                        ...
                        <input type="text" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" id="publishTime" name="publishTime" class="input-text Wdate" style="width:180px;" >
                    </div>
                    <div class="form-group">
