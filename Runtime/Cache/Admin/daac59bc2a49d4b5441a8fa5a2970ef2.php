    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            table = $('#example').dataTable({
                ...
                "ajax": {
                    "url": "<?php echo U('Admin/Mail/index');?>",
                    "type": "POST",
                    "data": {
                        'mycolumns': ['id', 'title', 'userName','content','pic','fruitNum','status', 'createTime','updateTime'],
                    },
                },
                //展示的列
                "columns": [
...
//                        },
                ...
                },
                    {
                        ...
                        "render": function(data, type, row) {
                            if(row['status']==0){
                                var btn = '<a href="javascript:void(0);"  onclik="check('+row['id']+')" class="btn btn-primary btn-xs btn-flat" >审核</a>';
                            }else{
                                var btn='';
                            }
        ...
        function check(id){
            layer.confirm('确定要审核吗？', {
                ...
                $.post("<?php echo U('check');?>",{id:id},function(data){
                    if (data.status) {
                        layer.msg(data.info, {
                            icon:1,
                            offset: 0,
